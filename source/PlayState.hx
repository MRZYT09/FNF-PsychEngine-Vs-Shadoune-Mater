...
class PlayState extends MusicBeatState
{
	...
	public var boyfriend:Boyfriend;
		...
		public static var mouseSpr:FlxSprite;
	//SHIELD
	...
	override public function create()
	{
		...
		mouseSpr = new FlxSprite(0, 0).loadGraphic(Paths.image('minecraft_cursor'));
	...
	{
		if (SONG.song.toLowerCase() == 'the-end'|| SONG.song.toLowerCase() == 'Termination')
			{
				vocals.volume = 2;
			}
		startingSong = false;
	...
	public static var angelnote:Bool = false;
	...
	function noteMiss(daNote:Note):Void { //You didn't hit the key and let it go offscreen, also used by Hurt Notes
		...
		{
			case 'Warning Note': //warning note miss
	...
	function AngelTimer():Void //gapple note
		{
	...
	function HealthDrain():Void //code from vs bob
		{
			...
			var fire = new FlxSprite(0, FlxG.height * 1.2).loadGraphic(Paths.image('FIRE'));
			if (ClientPrefs.downScroll)
				{	
					fire.y = 50;
				}
